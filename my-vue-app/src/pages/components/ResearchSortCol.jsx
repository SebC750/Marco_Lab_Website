                    ...
                    <div className="research-list">
                        ...
                        <div className="filter-container">
                            <a href="https://scholar.google.com/citations?user=SpLyrvoAAAAJ&hl=es">
                                <button id="buttons" className="btn btn-info d-inline-flex align-items-center gap-2 w-100 text-white mb-3 rounded-0">
                            ...
                            <a href="https://www.researchgate.net/profile/Marco-Giraldo" >
                                <button id="buttons" className="btn btn-info d-inline-flex align-items-center gap-2 w-100 text-white rounded-0" >
