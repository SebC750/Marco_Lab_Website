                                ...
                                {descriptions[0][group].map((val) => (
                                    <div key={val.id} className="col-12 mb-3 d-flex">
                                        <div className="card w-100 h-100 team-card mb-2 shadow shadow-md">
                                            <img
                                                src={`${val.foto_perfil ? val.foto_perfil : null}`}
                                            ...
                                            <div className="card-body d-flex flex-column justify-content-between">
                                                ...
                                                <div className="d-flex flex-column gap-2">
                                                    ...
                                                    <button type="button" className="btn btn-info d-block w-100 rounded-0 text-white" data-bs-toggle="collapse" data-bs-target={`#profile-desc-${val.id}`} aria-expanded="false" aria-controls={`profile-desc-${val.id}`}>
                                                        About me
                                                    </button>
